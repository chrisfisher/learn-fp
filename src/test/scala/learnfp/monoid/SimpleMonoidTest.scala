...
class SimpleMonoidTest extends WordSpecLike with Matchers {
  ...
  "sum monoid" should {
    ...
    "obey identity" in {
      Sum(10) |+| Monoid.empty[Sum] shouldBe Sum(10)
      Monoid.empty[Sum] |+| Sum(10) shouldBe Sum(10)
    }
  ...
  "product monoid" should {
    ...
    "obey identity" in {
      Product(10) |+| Monoid.empty[Product] shouldBe Product(10)
      Monoid.empty[Product] |+| Product(10) shouldBe Product(10)
    }

    "obey associativity" in {
      (Product(10) |+| Product(20)) |+| Product(30) shouldBe
